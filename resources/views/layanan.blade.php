        ...
        <div class="container bg-light"> 
          <div class="row justify-content-center">
            ...
            <div class="col-md-4 mb-5">
              <a href="#" class="text-decoration-none" style="color: #3EB772">
          ...
          <div class="row justify-content-center">
            <h3 class="mb-3 pt-5" style="color: #3EB772"><i class="bi bi-arrow-right-square"></i> Pilih layanan website yang tersedia</h3>
            <div class="col-md-4 mb-5">
              <a href="#" class="text-decoration-none" style="color: #3EB772">
                <div class="card rounded border-success bg-transparent">
