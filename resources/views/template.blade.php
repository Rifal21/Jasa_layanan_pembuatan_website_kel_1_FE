...
@section('container')
    <div class="row">
      <div class="col">
        <h1 class="text-center text-light mb-5">Template</h1>
        <div class="container bg-light"> 
          <div class="row justify-content-center">
            <h3 class="mb-3 pt-5" style="color: #3EB772"><i class="bi bi-arrow-right-square"></i> Template yang banyak digunakan</h3>
              ...
              <a href="#pilih" class="text-decoration-none" style="color: #3EB772">
                <div class="card rounded border-success bg-transparent">
                  ...
                  <div class="card-body text-center">
                    <h5 class="card-title fw-bold fs-4">{{ $item->nama_template }}</h5>
