...
@section('container')
  ...
  <div class="table-responsive col-lg-8">
    <a href="/dashboard/portfolio/create" class="btn btn-primary mb-3">Create Portfolio</a>
    <table class="table table-striped table-sm">
      ...
      <tbody>
        @foreach ($portfolios as $template)
          <tr>
            ...
            <td>
              ...
              <a href="/dashboard/portfolio/{{ $template['id'] }}/edit" class="badge bg-warning"><span data-feather="edit" class="align-text-bottom"></span></a>

              <form action="{{ route('portfolio.destroy', $template['id']) }}" method="POST" class="d-inline">
              @method('delete')
              @csrf
